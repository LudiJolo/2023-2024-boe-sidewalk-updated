...
export default function SidewalkCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setV_displacement(initialValues.v_displacement);
    setCompliance(initialValues.compliance);
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createSidewalk.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "SidewalkCreateForm")}
      {...rest}
    >
      <TextField
        label="Sid"
